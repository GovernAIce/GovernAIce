...
const ComplianceAnalysisWidget: React.FC<ComplianceAnalysisWidgetProps> = ({ analysisResults }) => {
        ...
        <div className="flex justify-between items-center flex-shrink-0">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className={`px-3 py-2 text-xs rounded h-8 flex items-center justify-center min-w-[70px] transition-colors ${
                viewMode === 'compliance' 
